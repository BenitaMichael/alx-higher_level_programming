...
class Base:
    """Represention of the the base model
    ...
    def __init__(self, id=None):
        ...
        Args:
            id (int): unique identity of the new Base
        """
        if id is not None:
            self.id = id
        else:
    ...
    def to_json_string(list_dictionaries):
        """Return the JSON format of a list of dicts.
    ...
    def save_to_file(cls, list_objs):
        """Write the JSON format of a list of objects to a file.
    ...
    def load_from_file(cls):
        """Return a list of classes created from JSON strings.

        Reads from `<cls.__name__>.json`.

        Returns:
           AN empty list if the file does not exists.
    ...
    def save_to_file_csv(cls, list_objs):
        """Write the CSV serialization of objects to a file.
